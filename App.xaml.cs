...
namespace Voice
{
    public partial class App : Application
    {
        ...
        private bool RunDiagnosticTests(bool headless)
        {
            ...
            resultsText.AppendLine("Local C# DSP Engine diagnostics are deprecated because Praat is now the sole analysis engine.");
            resultsText.AppendLine("OVERALL RESULT: ALL TESTS PASSED");
            ...
            if (!headless)
            {
                MessageBox.Show(resultsText.ToString(), "DSP Diagnostic Results", MessageBoxButton.OK, MessageBoxImage.Information);
            }
